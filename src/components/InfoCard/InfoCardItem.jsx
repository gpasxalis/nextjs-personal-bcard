...
const InfoCardItem = (props) => {
    return(
        <div className="bg-dark-blue w-full h-16 flex items-center py-3 px-1 rounded-md border-2 text-off-white gap-10 shadow-sm">
            ...
            <h3 className="font-normal font-geistSans text-base">
                <Link href={props.link} target="_blank">
                    {props.text}
                </Link>
            </h3>
